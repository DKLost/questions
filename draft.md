...
- X  ⇒ R: M //省略F，等价于~的~X ⇒ R: M，相当于(<<2 (<<1 R (确定约束者为 X A)) M)
- ~F~X ⇒ M //省略R: ，等价于~F~X ⇒ 是: M
- ~F~⇒ R: M //省略X，等价于~F~self⇒ R: M
- R: M //省略~F~X ⇒ ，等价于~的~self ⇒ R: M，该格式不允许有子项
- M //省略X ⇒ R ，等价于~的~self ⇒ 是: M，该格式不允许有子项
- ~F~X: //省略⇒ R: M，等价于~F~X ⇒ 是: X，该格式必须有子项
- X: //省略~F~...⇒ R: M，等价于~的~X ⇒ 是: X，该格式必须有子项
